 ...
 * This class takes care of keeping a local cache, syncing to the server, and (eventually) sharing
 * with other bluetooth-connected devices also running the app.
 * <p/>
...
public class FileUtils {
    ...
    public static void updateFilePathStrings() {
        ...
        // (since the strings are `static`, when any instances of FileUtils update these, all
        // instances will get the updates)
        SharedPreferences SP = PreferenceManager.getDefaultSharedPreferences(App.getContext());
        sLocalToplevelFilePath = Environment.getExternalStoragePublicDirectory(
                Environment.DIRECTORY_DOCUMENTS).getAbsolutePath() + "/" +
                //was App.getContext().getString(R.string.FILE_TOPLEVEL_DIR);
                "MEMO";
//      sLocalToplevelFilePath = Environment.getExternalStorageDirectory().getAbsolutePath() + "/" + "MEMO");
        sLocalEventFilePath = sLocalToplevelFilePath + "/" + "events";
        sLocalTeamPhotosFilePath = sLocalToplevelFilePath + "/" + "TeamPhotos";
...
//                    new BufferedReader(new FileReader(sLocalCommentFilePath + "/" + teamNumber + COMMENT_FILE_PATH));
//
            ...
            for (File subFile : files) {
                if (subFile.isDirectory()) {
                    ...
                    try {
                        ...
                        Log.e("MEMO", "Error parsing or downsizing image:", e);
                    }
...
//
     ...
     *
 //    * @param teamNumber The team who's photos we want to load.
