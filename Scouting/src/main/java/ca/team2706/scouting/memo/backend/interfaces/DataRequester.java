package ca.team2706.scouting.memo.backend.interfaces;
 ...
 * the activity's updateData(matchResultsDataCSV, matchScoutingDataCSV) with whatever gearDeliveryData is locally cached.
